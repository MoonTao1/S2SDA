...
from network.code.module.BaseBlocks import BasicConv2d
from network.code.utils.tensor_ops import cus_sample, upsample_add
from network.code.backbone.origin.from_origin import Backbone_ResNet50_in3, Backbone_VGG16_in3
from network.code.module.MyModule import AIM, SIM
...
class MINet_Res50(nn.Module):
    ...
    def forward(self, in_data):
        ...
        return out_data.sigmoid()
        # return {
        #     "mask": out_data.sigmoid(),  # [B,1,H,W]
        #     "f4": in_data_4,  # [B,64,H/4,W/4]
        #     "f8": in_data_8,  # [B,64,H/8,W/8]
        #     "f16": in_data_16  # [B,64,H/16,W/16]
        # }
